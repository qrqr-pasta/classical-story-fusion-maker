...
def main():
    ...
    with st.sidebar:
        ...
        custom_text = st.text_area(
            "自由入力（プロンプトに追加する指示）",
            value="楽しい話にしてくださいね。あくまで、物語の類型やエッセンスを参考にするだけであって、実際に個人名や地名を引用する必要はありません。現代の若者や老人や子供や女性や会社員へ寄り添う思いを入れてくれてもいいです。でも無理やり入れなくてもいいです。自然に読める話にしてください。登場人物の名前は、特に主人公は覚えやすい特徴的な名前にしてください。ラストは、星新一のようなあざやかなオチがあると、もっといいです。でも、ほっこりした温かい終わり方でも良いです。余韻を残すような終わり方でも良いです。",
            height=120
        )
